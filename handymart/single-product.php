        ...
        <?php while (have_posts()) : the_post(); ?>
            <div class="short-description">
                            ...
                            <ul>
                                ...
                                if ($attachments) {
                                    foreach ($attachments as $attachment) {
                                        $img = wp_get_attachment_image_src($attachment->ID, '394x398');
                                        ?>
                                        <li >
                ...
                <div class="product-info">
                    ...
                    <div class="mb5"><strong>Tỷ lệ:</strong> <?php echo get_post_meta(get_the_ID(), "ty_le", true); ?></div>
                    <div class="mb5"><strong>Hãng sản xuất:</strong> <?php echo get_post_meta(get_the_ID(), "hang_sx", true); ?></div>
                    <div class="mb5"><strong>Kích thước:</strong> <?php echo get_post_meta(get_the_ID(), "kich_thuoc", true); ?></div>
            ...
            <div class="description">
                <div class="fb-comments" data-width="100%" data-href="<?php $current_url = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; echo $current_url; ?>" data-numposts="5" data-colorscheme="light"></div>
                <div id="tabs">
                    <ul>
                    ...
                    <div class="itemboxmore">
                        <div class="thumb">
                            <a class="img_boxmore" href="<?php the_permalink(); ?>">
                                <img src="<?php the_post_thumbnail_url('225x216'); ?>" title="<?php the_title(); ?>" alt="<?php the_title(); ?>"/>
                            </a>
                        </div>
