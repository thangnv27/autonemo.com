    <div class="footer">
        ...
        <p>&nbsp;&nbsp;Giấy phép số: <?php echo get_option(SHORT_NAME . '_linkDMCA'); ?></p>
        <p class="socials">
            <a href="<?php echo get_option(SHORT_NAME . "_fbURL") ?>" class="icon-fb"></a>
            <a href="sms:<?php echo get_option(SHORT_NAME . "_hotline") ?>" class="icon-zalo"></a>
        </p>
      </p>
    </div>
</div>
